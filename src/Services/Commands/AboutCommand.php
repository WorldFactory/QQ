...
class AboutCommand extends Command
{
    ...
    {
        $this
            ->setDescription('Displays information about the QQ project')
            ->setHelp(<<<'EOT'
The <info>%command.name%</info> command displays information about the current QQ project.

The <info>PHP</info> section displays important configuration that could affect your application.
...
EOT
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $rows = array(
            ...
            array('Root directory', $kernel->getProjectDir()),
