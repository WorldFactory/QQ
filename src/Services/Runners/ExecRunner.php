...
Historically, this Runner was created to overcome some cases where the Runner Bash was struggling to function.
In the meantime, the Runner Bash has been greatly improved and the cases where the Runner Exec is useful have become very rare.
